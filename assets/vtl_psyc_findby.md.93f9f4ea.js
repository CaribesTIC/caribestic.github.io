import{_ as n,c as s,o as a,a as t}from"./app.7cdb76e5.js";const g='{"title":"findBy","description":"","frontmatter":{},"headers":[],"relativePath":"vtl/psyc/findby.md"}',e={},o=t(`<h1 id="findby" tabindex="-1"><code>findBy</code> <a class="header-anchor" href="#findby" aria-hidden="true">#</a></h1><div class="info custom-block"><p class="custom-block-title">Prueba</p><p><a href="https://www.youtube.com/watch?v=6UypB6LRysc&amp;list=PLC2LZCNWKL9YdD4Z4V6guveajQoKN8rui&amp;index=5" target="_blank" rel="noopener noreferrer">Esta lecci\xF3n en video</a></p></div><p>Hasta ahora hemos visto algunas formas en que Vue Testing Library difiere de Vue Test Utils. Cuando llamamos <code>fireEventet</code> en lugar de usar <code>trigger</code> y <code>waitFor</code> en lugar usar <code>nextTick</code>.</p><div class="language-js"><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlighted">\xA0</div><div class="highlighted">\xA0</div><br><br><div class="highlighted">\xA0</div><div class="highlighted">\xA0</div><br><br><br><br></div><pre><code><span class="token comment">// tests/components/helloworld.js</span>
...
</code></pre></div><p>Lo que haremos ser\xE1 cambiar ligeramente nuestras afirmaciones. En lugar de usar <code>waitFor</code>, ahora usaremos el selector <code>findByText</code>, del que hablamos previamente. Recordemos que este funciona de forma <a href="https://developer.mozilla.org/en-US/docs/Glossary/Asynchronous" target="_blank" rel="noopener noreferrer">as\xEDncrona</a>, es decir, devuelve una <a href="https://developer.mozilla.org/en/docs/Web/JavaScript/Reference/Global_Objects/Promise" target="_blank" rel="noopener noreferrer">promesa</a>. Esto nos permitir\xE1 esperar a que aparezca ese elemento.</p><p>Lo que tenemos que hacer aqu\xED es colocarlo con <code>await</code> y esta prueba pasar\xE1.</p><div class="language-js"><div class="highlight-lines"><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><div class="highlighted">\xA0</div><br><br></div><pre><code><span class="token comment">// tests/components/helloworld.js</span>
<span class="token keyword">import</span> <span class="token punctuation">{</span> render<span class="token punctuation">,</span> screen<span class="token punctuation">,</span> fireEvent<span class="token punctuation">,</span> waitFor <span class="token punctuation">}</span> <span class="token keyword">from</span> <span class="token string">&quot;@testing-library/vue&quot;</span>
<span class="token keyword">import</span> <span class="token string">&quot;@testing-library/jest-dom&quot;</span>
<span class="token keyword">import</span> HelloWorld <span class="token keyword">from</span> <span class="token string">&quot;@/components/HelloWorld.vue&quot;</span>
